...
| <a href='https://www.google.fr/search?q=linux+locate'>locate</a> | localise un programme dans le système | which | NI |
| <a href='https://www.google.fr/search?q=linux+lsb_release'>lsb_release</a> | version distribution | uname | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+uname'>uname</a> | version noyau | lsb_release | _installed_ |
...
| Nom | Description | Voir aussi | Statut |
|-----|-----|-----|-----|
| <a href='https://www.google.fr/search?q=linux+bat'>bat</a> | cat en mieux | cat,tail | NI |
...
| <a href='https://www.google.fr/search?q=linux+head'>head</a> | premières lignes texte | tail | _installed_ |
| <a href='https://www.google.fr/search?q=linux+less'>less</a> | filtre d'affichage | more | _installed_ |
| <a href='https://www.google.fr/search?q=linux+more'>more</a> | filtre d'affichage | less | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+tac'>tac</a> | affiche ordre inversé | cat | _installed_ |
| <a href='https://www.google.fr/search?q=linux+tail'>tail</a> | dernières lignes texte | head | _installed_ |
...
| Nom | Description | Voir aussi | Statut |
|-----|-----|-----|-----|
| <a href='https://www.google.fr/search?q=linux+cd'>cd</a> | _Change Directory_ | pushd | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+cp'>cp</a> | copie fichier(s) | mv | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+mv'>mv</a> | déplacement/renommage | cp | _installed_ |
| <a href='https://www.google.fr/search?q=linux+popd'>popd</a> | récupération dossier courant | pushd | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+pushd'>pushd</a> | chgt dossier courant avec sauvegarde | popd | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+rm'>rm</a> | suppression fichier | rmdir | _installed_ |
| <a href='https://www.google.fr/search?q=linux+rmdir'>rmdir</a> | supression dossier | rm | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+nslookup (_deprecated_)'>nslookup (_deprecated_)</a> | outil DNS | dig | NI |
...
| <a href='https://www.google.fr/search?q=linux+wget'>wget</a> | client http CLI | curl | _installed_ |
...
| Nom | Description | Voir aussi | Statut |
|-----|-----|-----|-----|
| <a href='https://www.google.fr/search?q=linux+chage'>chage</a> | _change user password expiry information_ | passwd | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+tar'>tar</a> | utilitaire archivage | zip | _installed_ |
| <a href='https://www.google.fr/search?q=linux+umask'>umask</a> | permissions par défaut | chmod | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+unzip'>unzip</a> | décompression zip | zip | _installed_ |
| <a href='https://www.google.fr/search?q=linux+zip'>zip</a> | compression zip | unzip | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+reboot'>reboot</a> |  | shutdown | _installed_ |
| <a href='https://www.google.fr/search?q=linux+sensors'>sensors</a> | données capteurs (température, tension, etc.) |  | NI |
| <a href='https://www.google.fr/search?q=linux+shutdown'>shutdown</a> |  | reboot | _installed_ |
| <a href='https://www.google.fr/search?q=linux+ss'>ss</a> | _list sockets_ |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+su'>su</a> | changement temp. d'utilisateur | sudo | _installed_ |
| <a href='https://www.google.fr/search?q=linux+sudo'>sudo</a> | exécution d'une commande admin | su | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+grep'>grep</a> | recherche de chaîne | ripgrep | _installed_ |
| <a href='https://www.google.fr/search?q=linux+paste'>paste</a> | fusion de lignes de texte de plusieurs fichiers |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+ripgrep'>ripgrep</a> | (rg) grep récursif | grep | NI |
...
| Nom | Description | Voir aussi | Statut |
|-----|-----|-----|-----|
| <a href='https://www.google.fr/search?q=linux+addgroup'>addgroup</a> | création groupe d'utilisateurs | adduser | _installed_ |
| <a href='https://www.google.fr/search?q=linux+adduser'>adduser</a> | création utilisateur |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+groupadd'>groupadd</a> | création groupe (bas niveau!) | addgroup | _installed_ |
| <a href='https://www.google.fr/search?q=linux+groups'>groups</a> | affiche les groupes existants | id | _installed_ |
| <a href='https://www.google.fr/search?q=linux+id'>id</a> | affiche les infos sur un utilisateur |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+passwd'>passwd</a> | changement pwd | chage | _installed_ |
| <a href='https://www.google.fr/search?q=linux+useradd'>useradd</a> | création utilisateur (bas niveau!) | adduser | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+screen'>screen</a> | multiplexeur de terminal | tmux | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+tmux'>tmux</a> | multiplexeur de terminal | screen | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+which'>which</a> | localisation (chemin) d'un programme | locate | _installed_ |
...
| Nom | Description | Voir aussi | Statut |
|-----|-----|-----|-----|
| <a href='https://www.google.fr/search?q=linux+bg'>bg</a> | passage d'un _job_ en arrière plan (_BackGround_) | fg | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+fg'>fg</a> | passage d'un _job_ au premier plan (_ForeGround_) | bg | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+htop'>htop</a> | top en mieux | top | _installed_ |
| <a href='https://www.google.fr/search?q=linux+jobs'>jobs</a> | affichage des _jobs_ lancés |  | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+kill'>kill</a> | stoppe un process par PID | pkill | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+killall'>killall</a> | stoppe tous les process par nom |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+pidof'>pidof</a> |  donne le PID d'un process | ps | _installed_ |
| <a href='https://www.google.fr/search?q=linux+pkill'>pkill</a> | stoppe un process par nom | kill | _installed_ |
| <a href='https://www.google.fr/search?q=linux+ps'>ps</a> | snapshot des process | top | _installed_ |
| <a href='https://www.google.fr/search?q=linux+pstree'>pstree</a> | arborescence des process |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+top'>top</a> | _dashboard_ système & process | htop | _installed_ |
