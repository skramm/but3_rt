...
| <a href='https://www.google.fr/search?q=linux+locate'>locate</a> | localise un programme dans le système | NI |
| <a href='https://www.google.fr/search?q=linux+lsb_release'>lsb_release</a> | version distrib. | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+uname'>uname</a> | version noyau | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+head'>head</a> | premières lignes texte | _installed_ |
| <a href='https://www.google.fr/search?q=linux+less'>less</a> | filtre d'affichage | _installed_ |
| <a href='https://www.google.fr/search?q=linux+more'>more</a> | filtre d'affichage | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+tac'>tac</a> | affiche ordre inversé | _installed_ |
| <a href='https://www.google.fr/search?q=linux+tail'>tail</a> | dernières lignes texte | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+ls'>ls</a> |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+mkdir'>mkdir</a> | _make directory_ | _installed_ |
| <a href='https://www.google.fr/search?q=linux+mv'>mv</a> | déplacement/renommage | _installed_ |
| <a href='https://www.google.fr/search?q=linux+popd'>popd</a> | récupération dossier courant | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+pushd'>pushd</a> | chgt dossier courant avec sauvegarde | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+rm'>rm</a> | suppression fichier | _installed_ |
| <a href='https://www.google.fr/search?q=linux+rmdir'>rmdir</a> | supression dossier | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+nslookup (_deprecated_)'>nslookup (_deprecated_)</a> | outil DNS | NI |
...
| <a href='https://www.google.fr/search?q=linux+wget'>wget</a> | client http CLI | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+tar'>tar</a> | utilitaire archivage | _installed_ |
| <a href='https://www.google.fr/search?q=linux+umask'>umask</a> | permissions par défaut | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+unzip'>unzip</a> | décompression zip | _installed_ |
| <a href='https://www.google.fr/search?q=linux+zip'>zip</a> | compression zip | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+reboot'>reboot</a> |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+sensors'>sensors</a> | données capteurs (température, tension, etc.) | NI |
| <a href='https://www.google.fr/search?q=linux+shutdown'>shutdown</a> |  | _installed_ |
| <a href='https://www.google.fr/search?q=linux+ss'>ss</a> | _list sockets_ | _installed_ |
| <a href='https://www.google.fr/search?q=linux+su'>su</a> | changement temp. d'utilisateur | _installed_ |
| <a href='https://www.google.fr/search?q=linux+sudo'>sudo</a> | exécution d'une commande admin | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+grep'>grep</a> | recherche de chaîne | _installed_ |
| <a href='https://www.google.fr/search?q=linux+paste'>paste</a> | fusion de lignes de texte de plusieurs fichiers | _installed_ |
| <a href='https://www.google.fr/search?q=linux+ripgrep'>ripgrep</a> | (rg) grep récursif | NI |
...
| <a href='https://www.google.fr/search?q=linux+useradd'>useradd</a> | création utilisateur (bas niveau!) | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+dpkg'>dpkg</a> | Utilitaire paquets .deb | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+screen'>screen</a> | multiplexeur de terminal | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+tmux'>tmux</a> | multiplexeur de terminal | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+which'>which</a> | localisation (chemin) d'un programme | _installed_ |
...
| <a href='https://www.google.fr/search?q=linux+htop'>htop</a> | top en mieux | _installed_ |
| <a href='https://www.google.fr/search?q=linux+jobs'>jobs</a> | affichage des _jobs_ lancés | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+kill'>kill</a> | stoppe un process par PID | _builtin_ |
| <a href='https://www.google.fr/search?q=linux+killall'>killall</a> | stoppe tous les process par nom | _installed_ |
| <a href='https://www.google.fr/search?q=linux+pidof'>pidof</a> |  donne le PID d'un process | _installed_ |
| <a href='https://www.google.fr/search?q=linux+pkill'>pkill</a> | stoppe un process par nom | _installed_ |
| <a href='https://www.google.fr/search?q=linux+ps'>ps</a> | snapshot des process | _installed_ |
| <a href='https://www.google.fr/search?q=linux+pstree'>pstree</a> | arborescence des process | _installed_ |
| <a href='https://www.google.fr/search?q=linux+top'>top</a> | _dashboard_ système & process | _installed_ |
